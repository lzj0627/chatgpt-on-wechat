...
class Midjourney(Plugin):
    def __init__(self):
        ...
        scheduler.add_job(self.query_task_result, 'interval', seconds=10, max_instances=5, misfire_grace_time=10)
        # 创建并启动一个新的线程来运行调度器
    ...
    def query_task_result(self):
        ...
        for task in tasks:
            ...
            if status == 'SUCCESS':
                ...
                logger.info("[Midjourney] 任务已完成: " + task_id)
